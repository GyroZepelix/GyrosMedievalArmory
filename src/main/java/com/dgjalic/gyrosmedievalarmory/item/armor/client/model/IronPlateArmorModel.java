...
public class IronPlateArmorModel extends ArmorModel{
	...
	public static LayerDefinition createBodyLayer()	{
		...
		PartDefinition hat = partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition visor_r1 = hat.addOrReplaceChild("visor_r1", CubeListBuilder.create().texOffs(33, 85).addBox(1.0671F, -1.1142F, -6.175F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.75F)), PartPose.offsetAndRotation(0.007F, -5.7053F, 0.8648F, -0.0847F, 0.7563F, -0.0637F));

		PartDefinition visor_r2 = hat.addOrReplaceChild("visor_r2", CubeListBuilder.create().texOffs(35, 73).addBox(1.5303F, -0.319F, -6.7004F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(0.007F, -5.7053F, -0.1352F, 0.6656F, 0.6291F, 0.476F));

		PartDefinition visor_r3 = hat.addOrReplaceChild("visor_r3", CubeListBuilder.create().texOffs(70, 76).addBox(0.942F, -0.5973F, -5.8951F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.48F)), PartPose.offsetAndRotation(0.007F, -5.7053F, 0.8648F, 0.3786F, 0.7365F, 0.2939F));
		...
		PartDefinition right_arm_r2 = right_arm.addOrReplaceChild("right_arm_r2", CubeListBuilder.create().texOffs(92, 0).mirror().addBox(-4.4656F, 0.2386F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.2F)).mirror(false)
	...
	public static LayerDefinition createVariantBodyLayer() {
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();

		PartDefinition hat = partdefinition.addOrReplaceChild("hat", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition visor_r1 = hat.addOrReplaceChild("visor_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-4.007F, -2.2947F, -4.8648F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)), PartPose.offsetAndRotation(0.007F, -3.6413F, 1.7347F, -1.309F, 0.0F, 0.0F));

		PartDefinition visor_r2 = hat.addOrReplaceChild("visor_r2", CubeListBuilder.create().texOffs(33, 85).addBox(1.0671F, -1.1142F, -6.175F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.75F)), PartPose.offsetAndRotation(0.007F, -3.6413F, 1.7347F, -1.4208F, 0.1332F, -0.7489F));

		PartDefinition visor_r3 = hat.addOrReplaceChild("visor_r3", CubeListBuilder.create().texOffs(35, 73).addBox(1.5303F, -0.319F, -6.7004F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(0.007F, -4.6072F, 1.4759F, -0.9648F, 0.5354F, -0.5815F));
